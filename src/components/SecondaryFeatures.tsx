...
const features: Array<Feature> = [
  {
    name: 'Matching',
    summary:
      'We specialize in connecting talented professionals with top employers for rewarding careers.',
    description:
      'We are committed to empowering professionals from around the globe to thrive in the Dutch job market. ',
    image: team2,
  ...
  },
  {
    name: 'Competitive',
    summary:
      'We help connecting professionals with roles that offer competitive salaries and benefits packages',
    description:
      'Our tailored approach ensures that professionals find roles that not only match their skills but also provide them with the financial security they deserve.',
    image: team1,
...
export function SecondaryFeatures() {
  return (
    <section id="secondary-features" className="pb-14 pt-4 md:pt-20 lg:pb-32">
      <Container>
